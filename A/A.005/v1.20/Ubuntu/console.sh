...
sudo -u vagrant sshpass -p 'vagrant' scp -o StrictHostKeyChecking=no root@192.168.2.$2:/root/.kube/config $va_k8s_cfg-$2
sudo -u vagrant sshpass -p 'vagrant' scp -o StrictHostKeyChecking=no root@192.168.2.$3:/root/.kube/config $va_k8s_cfg-$3
sudo -u vagrant sshpass -p 'vagrant' scp -o StrictHostKeyChecking=no root@192.168.2.$4:/root/.kube/config $va_k8s_cfg-$4
